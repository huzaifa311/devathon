      ...
      <div className="">
        ...
        <div className=" flex justify-center mt-10">
          <div className="bg-gray-100 w-96 p-8 border border-slate-400 rounded-lg boxShadow">
            <form /* onSubmit={handleSignupSubmit} */ className="w-full b-10">
              <div className="mb-4">
                <TextField
                  type="text"
                  // id='outline-basic'
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  name="img"
                  accept="image/*"
                  className="w-full text-sm sm:text-lg p-2 border  hover:border-gray-600 border-gray-300 rounded focus:outline-none focus:border-teal-700"
