  ...
  return (
    <div className='shadow-2xl w-full fixed top-0 left-0 z-[100]'>
      <div className={`md:flex items-center justify-between bg-teal-700 py-4 md:px-10 px-7`}>
        ...
        <ul className={`md:flex bg-teal-700 md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full h-[200%] md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-12' : 'top-[-490px]'}`}>
